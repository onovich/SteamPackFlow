...
After a real upload succeeds, any source zip that came from `Win/inbox` is moved to `Win/inbox/done`. The script creates `Win/inbox/done` automatically when needed.
